    ...
    <div className="w-64 bg-white shadow-xl h-full flex flex-col">
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-full bg-luxury-plum flex items-center justify-center">
            <span className="text-white font-bold text-xl">N</span>
          </div>
          <div>
            <h1 className="text-xl font-playfair font-bold text-luxury-plum">Nysha</h1>
                ...
                className={({ isActive }) =>
                  `flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                    isActive
                      ...
                      : 'text-gray-700 hover:bg-luxury-plum/10 hover:text-luxury-plum'
                  }`
                }
              >
