...
const PaymentSummary = ({ bookingData, depositPercentage = 30 }) => {
  const depositAmount = (bookingData.total_price * depositPercentage) / 100
  const remainingAmount = bookingData.total_price - depositAmount
    ...
    >
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex justify-between items-center py-2 border-b border-gray-100">
          ...
          <span className="font-semibold text-gray-900">{bookingData.service_name}</span>
        </div>
        ...
        <div className="flex justify-between items-center py-2 border-b border-gray-100">
          ...
          <span className="font-semibold text-gray-900">{bookingData.full_name}</span>
        </div>
        ...
        <div className="mt-4 pt-2">
          <div className="flex justify-between items-center py-2">
            ...
            <span className="font-semibold text-gray-900">{formatCurrency(bookingData.total_price)}</span>
          </div>
